...
#excercise 2-3
library(ggplot2)
ggplot(expenditure,aes(x=X1,y=Y,color=factor(Region),shape=factor(Region)))+geom_point()+
  labs(x="income",y="expenditure")+scale_color_manual(values=c("1"="pink","2"="orange","3"="red","4"="blue"))+
  scale_shape_manual(values=c("1"="10","2"="12","3"="14","4"="16"))+
  theme_minimal()
